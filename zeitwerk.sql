...
CREATE TABLE `companies` (
  ...
  `name` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `street_no` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `additional_address` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `additional_company_name` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
